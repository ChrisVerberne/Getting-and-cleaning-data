...
A tidy dataset was created according to the instructions in the assignment. 
...
COLUMN NAMES OF THE TIDY DATA SET:
- Subject: subject column.
- Activity: activity column.
- All other columns according to "features.txt".
